...
<div class="py-12 px-4">
    <div class="max-w-4xl mx-auto">
        <div class="mb-8 flex justify-between items-center">
            <div>
                <h1 class="font-display text-3xl font-bold" style="color:#2E4636;">My Account</h1>
        ...
        <h2 class="font-semibold text-lg mb-4" style="color:#2E4636;">My Bookings</h2>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm">
                <div class="flex flex-wrap justify-between gap-4">
                    ...
                    <div class="text-right">
                        ...
                        <div class="mt-2">
                            <a href="{{ route('portal.booking', $b->reference) }}" class="text-xs font-medium" style="color:#BF6B47;">View Details →</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="text-center py-12 bg-white rounded-2xl shadow-sm">
            ...
            <a href="{{ route('booking') }}" class="inline-block px-6 py-3 rounded-xl text-white font-semibold" style="background-color:#BF6B47;">Book Your Stay</a>
        </div>
        @endif
    </div>
</div>
