...
<div class="py-12 px-4">
    <div class="max-w-xl mx-auto">
        ...
        <div class="bg-white rounded-2xl p-8 shadow-sm">
            <h1 class="font-display text-2xl font-bold mb-6" style="color:#1E3A4A;">Edit Profile</h1>
            <form action="{{ route('portal.profile.update') }}" method="POST" class="space-y-5">
                ...
                <button type="submit" class="w-full py-3 rounded-xl text-white font-semibold transition hover:opacity-90" style="background-color:#D07A54;">Save Changes</button>
            </form>
        </div>
    </div>
</div>
