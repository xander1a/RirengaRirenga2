...
<div class="flex flex-wrap gap-4 mb-6 items-end">
    <form method="GET" class="flex flex-wrap gap-3 items-end">
        ...
        <button type="submit" class="px-4 py-2.5 min-h-[44px] rounded-xl text-white text-sm font-semibold" style="background-color:#2E4636;">Apply</button>
...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 mb-8">
    @foreach([
        ['icon'=>'calendar', 'value'=>$totalBookings, 'label'=>'Total Bookings', 'color'=>'#2E4636'],
        ['icon'=>'banknotes', 'value'=>frw($totalRevenue), 'label'=>'Revenue (paid only)', 'color'=>'#C9A24B'],
        ['icon'=>'building', 'value'=>$occupancyRate.'%', 'label'=>'Occupancy Rate', 'color'=>'#6E8C5A'],
        ['icon'=>'alert-triangle', 'value'=>$bookings->where('payment_status','pending')->count(), 'label'=>'Pending Payments', 'color'=>'#BF6B47'],
    ] as $m)
...
<div class="bg-white rounded-2xl shadow-sm p-6 mb-8">
    <h3 class="font-semibold mb-4" style="color:#2E4636;">Revenue by Payment Method</h3>
    <div class="space-y-3">
        ...
        <div class="flex justify-between items-center py-2 border-b border-gray-100 text-sm">
            ...
            <div class="text-right">
                <span class="font-bold" style="color:#C9A24B;">{{ frw($data['total'],2) }}</span>
...
<div class="bg-white rounded-2xl shadow-sm overflow-hidden">
    <div class="px-6 py-4 border-b border-gray-100">
        <h3 class="font-semibold" style="color:#2E4636;">Bookings in Period</h3>
    </div>
